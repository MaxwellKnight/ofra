            ...
            <div className='about'>
                ...
                <div className='secondary-about'>
                    <p className='about-text'>
                        עופרה (אנגל) יחיאלי, ילידת הרצליה שנת 1995, מבאר שבע
                    ...
                    <p className='aside-text'>
                        ...
                        בין לבין משתדלת לתת מקום לתחביביי השונים כמו - כתיבת ספרים (לצעירים וצעירים ברוחם), שירים ומנגינות,
                        שירים ומנגינות, קריאה, עבודות גינון, ציור וחזירת תכשיטים.
